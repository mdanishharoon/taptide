...
const navLinks = [
    { href: "/sutton-arms", label: "Home" },
    { href: "/sutton-arms/sports", label: "Sports" },
    { href: "/sutton-arms/whats-on", label: "What's On" },
    { href: "/sutton-arms/menu", label: "Menu" },
    { href: "/sutton-arms/contact", label: "Contact" },
];

export default function SuttonArmsNavbar() {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    {/* Logo */}
                    <Link href="/sutton-arms" className="group">
                    ...
                    >
                        ...
                        <motion.span
                            ...
                            style={{ backgroundColor: "var(--antique-cream)" }}
                            animate={{ opacity: isMobileOpen ? 0 : 1, x: isMobileOpen ? 20 : 0 }}
                        />
                        <motion.span
                            className="w-6 h-0.5 block origin-center"
                            style={{ backgroundColor: "var(--antique-cream)" }}

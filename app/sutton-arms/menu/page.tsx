...
export default function SuttonArmsMenuPage() {
        ...
        <>
            ...
            <main className="min-h-screen" style={{ backgroundColor: "var(--antique-cream)" }}>
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="text-center mb-10">
                                    <h2 className="text-3xl md:text-4xl mb-2" style={{ fontFamily: "var(--font-display)", color: "var(--deep-navy)" }}>
                                        {currentCategory?.name}
                                    </h2>
                                    <p className="text-lg opacity-60" style={{ fontFamily: "var(--font-body)", color: "var(--deep-navy)" }}>
                                    ...
                                    {currentCategory?.items.map((item, index) => (
                                        ...
                                        >
                                            <div className="flex-1">
                                                <h3 className="text-lg md:text-xl mb-1" style={{ fontFamily: "var(--font-display)", color: "var(--deep-navy)" }}>
                                                    {item.name}
                                                </h3>
                                                <p className="text-sm opacity-70" style={{ fontFamily: "var(--font-body)", color: "var(--deep-navy)" }}>
                                                    {item.description}
                                                </p>
                                            </div>
                                            <span className="text-xl font-semibold whitespace-nowrap" style={{ fontFamily: "var(--font-display)", color: "var(--golden-bronze)" }}>
                                                £{item.price}
                                            </span>
                                        </motion.div>
                                    ))}
                ...
                <section className="py-8 px-6 text-center" style={{ backgroundColor: "var(--deep-navy)" }}>
                    <p className="text-sm opacity-70" style={{ fontFamily: "var(--font-body)", color: "var(--antique-cream)" }}>
